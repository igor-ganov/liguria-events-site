...
facets: { today: { title: "Что идёт сегодня в {place}", description: "События сегодня в {place} — время, места и билеты." }, tomorrow: { title: "Что идёт завтра в {place}", description: "События завтра в {place} — время, места и билеты." }, weekend: { title: "Что идёт в выходные в {place}", description: "События в субботу и воскресенье в {place} — время, места и билеты." }, free: { title: "Бесплатные события в {place}", description: "События со свободным входом в {place} — время, места и чего ждать." } }
