...
route: { walk: 'A piedi', drive: 'In auto', transit: 'Mezzi', generate: 'Genera itinerario', save: 'Salva itinerario', saved: 'Salvato', tight: 'Coincidenza stretta', min: 'min', empty: 'Nessun preferito — tocca il cuore su un evento per aggiungerlo.', link: 'Link condivisibile', saveFailed: 'Impossibile salvare l’itinerario — riprova.', mine: 'I miei itinerari', open: 'Apri', private: 'Privato', public: 'Pubblico', makePrivate: 'Rendi privato', makePublic: 'Rendi pubblico', remove: 'Elimina', title: 'Itinerario', by: 'Un itinerario condiviso', moveDay: 'Sposta al giorno', moveUp: 'Su', moveDown: 'Giù', addFav: 'Aggiungi dai preferiti…', saveChanges: 'Salva modifiche', viewList: 'Elenco', viewTimeline: 'Cronologia', pdf: 'Scarica PDF', day: 'Giorno', setDefault: 'Predefinito' }
