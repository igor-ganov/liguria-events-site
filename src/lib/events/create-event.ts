...
export const createEvent = async (
  ...
  await env.DB.prepare(INSERT)
    .bind(id, user.id, e.title, e.description, e.startDate, e.endDate, e.categoriesJson, e.venue, e.address, e.phone, e.website, e.cover, e.lat, e.lng, e.free, e.sessionsJson, e.kind, now, now)
    .run();
