...
route: { walk: 'Пешком', drive: 'Авто', transit: 'Транспорт', generate: 'Построить маршрут', save: 'Сохранить', saved: 'Сохранено', tight: 'Мало времени', min: 'мин', empty: 'Пока нет избранного — жми на сердечко у события.' }
