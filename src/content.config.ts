...
const ui = defineCollection({
  ...
  schema: z.object({
    ...
    route: z.object({ walk: z.string(), drive: z.string(), transit: z.string(), generate: z.string(), save: z.string(), saved: z.string(), tight: z.string(), min: z.string(), empty: z.string(), link: z.string(), saveFailed: z.string(), mine: z.string(), open: z.string(), private: z.string(), public: z.string(), makePrivate: z.string(), makePublic: z.string(), remove: z.string(), title: z.string(), by: z.string() }),
