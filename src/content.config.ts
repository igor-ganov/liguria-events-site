...
const ui = defineCollection({
  ...
  schema: z.object({
    ...
    offline: z.object({ notice: z.string(), retry: z.string() }),
    ...
    contribute: z.object({ link: z.string(), venue: z.string(), empty: z.string(), ownEvent: z.string(), ownEventLink: z.string() }),
