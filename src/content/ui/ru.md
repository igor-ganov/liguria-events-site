...
range: { from: 'С', to: 'По' }
sort: { label: 'Сортировка', unique: 'По уникальности', created: 'Сначала новые' }
...
seo: { feed: "События и афиша — {place}: концерты, выставки, ярмарки и не только.", calendar: "Календарь событий — {place}: что происходит день за днём.", map: "Карта событий — {place}: найдите, что происходит рядом." }
cat:
  music: Музыка
  theatre: Театр
  art: Выставки
