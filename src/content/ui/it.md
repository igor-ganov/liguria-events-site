...
route: { walk: 'A piedi', drive: 'In auto', transit: 'Mezzi', generate: 'Genera itinerario', save: 'Salva itinerario', saved: 'Salvato', tight: 'Coincidenza stretta', min: 'min', empty: 'Nessun preferito — tocca il cuore su un evento per aggiungerlo.', link: 'Link condivisibile', saveFailed: 'Impossibile salvare l’itinerario — riprova.', mine: 'I miei itinerari', open: 'Apri', private: 'Privato', public: 'Pubblico', makePrivate: 'Rendi privato', makePublic: 'Rendi pubblico', remove: 'Elimina', title: 'Itinerario', by: 'Un itinerario condiviso', moveDay: 'Sposta al giorno', moveUp: 'Su', moveDown: 'Giù', addFav: 'Aggiungi dai preferiti…', saveChanges: 'Salva modifiche', viewList: 'Elenco', viewTimeline: 'Cronologia', pdf: 'Scarica PDF', day: 'Giorno', setDefault: 'Predefinito', setBase: 'Imposta base', setBaseDefault: 'Base predefinita', clearBase: 'Rimuovi', clickMap: 'Clicca sulla mappa per il punto…', dayBase: 'Base', dayFinal: 'Fine', fromBase: 'Dalla base', toBase: 'Ritorno alla base' }
menu: { events: 'Cosa fare', explore: 'Esplora', more: 'Altro' }
seo: { venueCount: { one: "{n} evento in programma a {place}", other: "{n} eventi in programma a {place}" }, venueTitle: "{place}: eventi in programma", venue: "{place}: eventi in programma, date, orari e biglietti.", feed: "Eventi e cosa fare a {place} — concerti, mostre, mercati e altro.", calendar: "Calendario eventi di {place} — cosa fare, giorno per giorno.", map: "Mappa degli eventi a {place} — scopri cosa c'è vicino a te." }
cat:
  music: Musica
  theatre: Teatro
  art: Mostre
...
offline:
  ...
  reload: "Mostrala"
  retry: "Riprova"
  listAway: "Questo elenco si scarica quando lo apri, e non c'è connessione. Tutto quello che hai già aperto è ancora qui."
outbox:
  queued: "Salvato su questo dispositivo. Sarà pubblicato appena torni online."
  waiting: "{count} in attesa di pubblicazione"
  conflict: "«{title}» è cambiato altrove mentre la tua modifica era in attesa, quindi non è stata sovrascritta. Aprilo per confrontare."
  sent: "Pubblicato: «{title}»."
submitLead: { lead: "Crea un evento e ottieni un link da mandare a chi vuoi che ci sia.", pointLink: "Ti diamo un indirizzo da incollare in qualsiasi chat.", pointFree: "Gratis, e puoi iniziare senza account.", pointWho: "Scegli tu chi lo vede: solo chi ricevi il link, o tutta la città." }
eventForm: { title: "Titolo", description: "Descrizione", image: "Immagine", categories: "Categorie", starts: "Inizia", addDate: "Aggiungi una data", removeDate: "Togli questa data", dateLabel: "Data", timeLabel: "Ora di inizio", whatIsOn: "Cosa c’è quel giorno", whatIsOnHint: "Cosa c’è (facoltativo)", venue: "Luogo", address: "Indirizzo", addressHint: "Via, città", phone: "Telefono", website: "Sito web", freeEntry: "Ingresso libero", mapLabel: "Posizione sulla mappa", mapHint: "Tocca la mappa per mettere il segnaposto — trascinalo per precisare.", submitCreate: "Invia per la revisione", submitEdit: "Salva le modifiche", uploadImage: "Carica un’immagine", replaceImage: "Sostituisci l’immagine" }
contribute: { link: "Aggiungi il tuo evento", venue: "Gestisci {place}? Aggiungi le tue date — l'inserimento è gratuito.", empty: "Sai di qualcosa a {place}? Aggiungilo.", ownEvent: "Vuoi radunare i tuoi?", ownEventLink: "Crea un evento — ci vuole un minuto ed è gratis." }
submitAuth: { note: "Compila pure: ti chiederemo di accedere una sola volta, al momento dell'invio.", signin: "Ci siamo: accedi per inviarlo. Quello che hai scritto resta qui." }
visibility: { legend: "Chi può vederlo", listedTitle: "Mostralo nel calendario della città", listedNote: "Prima lo controlliamo, poi lo trova chiunque sfogli la città.", linkNote: "Se lasci la casella vuota, lo apre solo chi riceve il link: resta fuori dal calendario e dai motori di ricerca." }
created: { heading: "Fatto — ecco il link", linkNote: "Lo apre solo chi lo riceve da te. Non è in nessun calendario e non è nei motori di ricerca.", publicNote: "Lo controlliamo a breve, poi lo troverà chiunque sfogli la città. Il link funziona già adesso.", copy: "Copia link", copied: "Copiato" , sendTo: "Mandalo a qualcuno", whatsapp: "WhatsApp", telegram: "Telegram"}
